...
div className="textbox" >
    ...
    i class="fa-solid fa-user-injured" > < /i> <
                                                                                                                    ...
                                                                                                                    value={
                                                                                                                        formik.values.nombre_contacto_emergencia
                                                                                                                    }
                                                                                                                    required=""
                                                                                                                    autoFocus="" />
                                                                                                                <
    ...
    div > {
                                                                                                                            formik.errors.nombre_contacto_emergencia
                                                                                                                        } < /div>
                                                                                                                        ) : null
} <
div className="textbox" >
    ...
    i class="fa-solid fa-phone" > < /i> <
                                                                                                                                    ...
                                                                                                                                    placeholder="Número Contacto de Emergencia"
                                                                                                                                    onChange={
                                                                                                                                        formik.handleChange
                                                                                                                                    }
                                                                                                                                    onBlur={
                                                                                                                                    ...
                                                                                                                                    value={
                                                                                                                                        formik.values.numero_contacto_emergencia
                                                                                                                                    }
                                                                                                                                    required=""
                                                                                                                                    autoFocus="" />
                                                                                                                                <
    ...
    div > {
                                                                                                                                            formik.errors.numero_contacto_emergencia
                                                                                                                                        } < /div>
                                                                                                                                        ) : null
} <
div className="textbox" >
    ...
    i class="fa-solid fa-hospital" > < /i> <
                                                                                                                                                    ...
                                                                                                                                                    value={
                                                                                                                                                        formik.values.asistencia_medica
                                                                                                                                                    }
                                                                                                                                                    required=""
                                                                                                                                                    autoFocus="" />
                                                                                                                                                <
    ...
    div > {
                                                                                                                                                            formik.errors.asistencia_medica
                                                                                                                                                        } < /div>
                                                                                                                                                        ) : null
} <
/div> < /
div > <
    button className="rg-btn"
                                                                                                                                                            type="submit" > Registrate < /button> {
                                                                                                                                                                error && < div className="text-danger text-center mt-3" > {
                                                                                                                                                                    error
                                                                                                                                                                } < /div>}
