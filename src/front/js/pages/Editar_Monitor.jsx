...
export const EditMonitor = () => {
    ...
    const handleClick = () =>{
       var myHeaders = new Headers();
		...
		fetch("https://3001-jphafelin-rutgreen-b2q87zot1t2.ws-eu93.gitpod.io/api/user/4", requestOptions)
        ...
        fetch("https://3001-jphafelin-rutgreen-b2q87zot1t2.ws-eu93.gitpod.io/api/monitor/1", requestOptions)
        .then(response => response.text())
        .then(result => console.log(result))
        .catch(error => console.log('error', error));
